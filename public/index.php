...
<body class="min-h-screen bg-[url('/Mall/public/asset/images/background.png')] bg-cover bg-center">
    <div class="min-h-screen bg-black/30 flex items-center justify-end px-[40px] py-[40px]">
        <div class="bg-[var(--primary)] backdrop-blur-lg px-[40px] py-[60px] rounded-[16px] border-[1.5px] border-[var(--accent)] w-full max-width-[450px]">
            <h1 class="text-[var(--text)] text-[36px] font-bold mb-[8px] text-center">
                Welcome Back!
            </h1>
            <p class="text-[var(--text-secondary)] text-center mb-[40px]">
            ...
            <form method="POST" action="auth/loginProcess.php" class="space-y-4">
                ...
                <div class="relative">
                    ...
                    name="role" 
                    required
                    class="w-full bg-[var(--primary)] border-[1.5px] border-[var(--accent)] rounded-[8px] px-[16px] py-[16px] text-[var(--text)] focus:outline-none focus:border-[var(--accent)] appearance-none">
                        <option value="" disabled selected class="text-[var(--text-secondary)]">-- Pilih Jabatan / Role --</option>
                        <option value="Finance Manager" class="bg-[var(--primary)] text-[var(--text)]">Finance Manager</option>
                        <option value="Finance Staff" class="bg-[var(--primary)] text-[var(--text)]">Finance Staff</option>
                        <option value="Purchasing Manager" class="bg-[var(--primary)] text-[var(--text)]">Purchasing Manager</option>
                        <option value="Purchasing Staff" class="bg-[var(--primary)] text-[var(--text)]">Purchasing Staff</option>
                    </select>
                </div>
