...
<head>
    ...
    <title>Tenant Portal Gabe</title>
    <style>
...
<div class="layout">
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            <a class="nav-item active" href="tenant_portal_gabe.php?tenant_id=<?= (int) $tenantId ?>">
                <span>👤</span>
        ...
        <section class="content-body">
            <div class="page-wrapper">
                ...
                <div class="page-header">
                    <div>
                        <p class="page-breadcrumb">Tenant Portal / PB-M02-04</p>
                        <h1 class="page-title">Tenant Portal</h1>
                        <p class="page-description">
                            Dashboard tagihan, pembayaran, unduh invoice/dokumen kontrak, dan pengajuan tiket keluhan yang terhubung ke database.
                        </p>
                    </div>

                    <div class="card" style="min-width: 270px; margin-bottom: 0;">
                        <p class="page-breadcrumb">Tenant Aktif</p>
                        <h2><?= htmlspecialchars($tenantName) ?></h2>
                        <p class="description">
                            Unit <?= htmlspecialchars($tenant['unit_code'] ?? '-') ?> ·
                            <?= htmlspecialchars($tenant['category_name'] ?? '-') ?>
                        </p>
                    </div>
                </div>
                ...
                <div class="stats-row">
                    <div class="stat-card">
                        <span class="stat-label">Tagihan Terbaru</span>
                        <span class="stat-value"><?= !empty($bills) ? rupiah($bills[0]['total_amount']) : 'Rp 0' ?></span>
                    </div>

                    <div class="stat-card">
                        <span class="stat-label">Dokumen Tersedia</span>
                        <span class="stat-value"><?= count($documents) ?></span>
                    </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div>
                            <h2 class="card-title">Fitur Tenant Portal</h2>
                            <p class="card-subtitle">Pilih fitur sesuai kebutuhan tenant.</p>
                        </div>
                    </div>

                    <div class="stats-row">
                        <a class="stat-card" href="tagihan.php?tenant_id=<?= (int) $tenantId ?>" style="text-decoration:none;color:inherit;">
                            <span class="stat-label">Tagihan & Pembayaran</span>
                            <span class="stat-value">Buka</span>
                        </a>

                        <a class="stat-card" href="invoice_dokumen.php?tenant_id=<?= (int) $tenantId ?>" style="text-decoration:none;color:inherit;">
                            <span class="stat-label">Invoice & Dokumen</span>
                            <span class="stat-value">Buka</span>
                        </a>

                        <a class="stat-card" href="tiket_keluhan.php?tenant_id=<?= (int) $tenantId ?>" style="text-decoration:none;color:inherit;">
                            <span class="stat-label">Tiket Keluhan</span>
                            <span class="stat-value">Buka</span>
                        </a>
                    </div>
                </div>
