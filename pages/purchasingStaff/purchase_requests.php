...
// Sesi default sementara untuk Purchasing Staff agar aman dicoba sekarang
$_SESSION['role'] = 'Purchasing Staff';
$_SESSION['nama'] = 'Staff Purchasing';
...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <?php if (isset($_SESSION['success_msg'])): ?>
            <div class="alert alert-success bg-success text-white border-0 p-2 mb-3 small"><?= $_SESSION['success_msg'];
                                                                                            unset($_SESSION['success_msg']); ?></div>
        <?php endif; ?>
        <?php if (isset($_SESSION['error_msg'])): ?>
            <div class="alert alert-danger bg-danger text-white border-0 p-2 mb-3 small"><?= $_SESSION['error_msg'];
