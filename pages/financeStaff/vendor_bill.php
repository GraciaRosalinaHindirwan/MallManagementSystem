...
// ====================================================================
// LOGIKA AUTHENTICATION & AUTHORIZATION (UNTUK FINANCE STAFF)
// ====================================================================
// Jika database sudah siap, silakan HAPUS tanda komen (/* dan */) di bawah ini:
/*
if (!isset($_SESSION['role']) || $_SESSION['role'] !== 'Finance Staff') {
...
// --------------------------------------------------------------------
// STRUKTUR KODE ASLI DI BAWAH TIDAK BERUBAH SAMA SEKALI
// --------------------------------------------------------------------
