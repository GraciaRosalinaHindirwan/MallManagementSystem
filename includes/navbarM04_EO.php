...
$department_name = 'Event Organizing';
$menu_items = [
    ['icon' => 'fa-solid fa-house',         'label' => 'Dashboard',        'link' => BASE_URL . '/pages/eventOrganizer/dashboard_eo.php',        'active_page' => 'dashboard_eo'],
    ['icon' => 'fa-solid fa-calendar-plus', 'label' => 'Event Request',   'link' => BASE_URL . '/pages/eventOrganizer/event_booking_form.php',  'active_page' => 'event_booking_form'],
    ['icon' => 'fa-solid fa-list-check',    'label' => 'Event Status', 'link' => BASE_URL . '/pages/eventOrganizer/event_booking_status.php','active_page' => 'event_booking_status'],
];
