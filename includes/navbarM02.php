...
foreach ($menu as $section) {
    if (!in_array($role, $section['roles'], true)) continue;
...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .m02-sidebar.collapsed { width: var(--sidebar-w-collapsed); }
        ...
        .m02-sidebar.collapsed .m02-brand { justify-content: center; padding: 20px 0 16px; }
        .m02-sidebar.collapsed .m02-nav-item { justify-content: center; padding: 10px 0; }
        .m02-sidebar.collapsed .m02-logout { justify-content: center; }
        .m02-sidebar.collapsed .m02-collapse-toggle .m02-collapse-arrow { transform: rotate(180deg); }
        ...
        .m02-sidebar.collapsed .m02-brand { gap: 0; }

        /* nav sections */
        .m02-nav { flex: 1; padding: 12px 0; }

        .m02-nav-section { margin-bottom: 4px; }
        ...
        .m02-nav-icon { font-size: 15px; min-width: 18px; text-align: center; }
        .m02-nav-label { overflow: hidden; text-overflow: ellipsis; }
        ...
        .m02-logout:hover { background: rgba(239,68,68,0.1); }
        ...
        .m02-sidebar-close:hover { opacity: 1; }
        ...
        .m02-hamburger:hover { opacity: 1; }
        .m02-hamburger.mobile-only { display: none; }
        ...
        @media (max-width: 768px) {
            .m02-sidebar {
                ...
                width: var(--sidebar-w) !important; /* collapse mode tidak berlaku di mobile */
            }
            .m02-sidebar.open {
            ...
            .m02-sidebar.collapsed .m02-nav-item::after { display: none; }
            .m02-collapse-toggle { display: none; }
            .m02-sidebar-close { display: block; }
            .m02-main { margin-left: 0 !important; }
            .m02-hamburger.mobile-only { display: block; }
            .m02-hamburger.desktop-only { display: none; }
            .m02-content { padding: 20px 16px; }
            .m02-module-badge { display: none; }
            .m02-overlay.open { display: block; }
        }
    </style>
</head>
<body>
...
<div class="m02-layout">
    ...
    <aside class="m02-sidebar" id="m02Sidebar">
        ...
        <div class="m02-brand">
            ...
            <button class="m02-collapse-toggle desktop-only" id="m02CollapseToggle" onclick="m02ToggleCollapse()" title="Collapse / Expand sidebar">
